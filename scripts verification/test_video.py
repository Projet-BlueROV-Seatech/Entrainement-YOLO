...
# 1. Charge ton modèle
model = YOLO(r"C:\Users\theoc\Desktop\Projet_SYSMER_2A\runs\detect\entrainement_sysmer2\weights\best.pt")  # A adapter  

# 2. Chemin de ta vidéo
video_path = r"C:\Users\theoc\Desktop\Projet_SYSMER_2A\Calibrage Direct\CAM2.avi" # A adapter 
...
results = model.predict(
    ...
    device=0   # Fait tourner l'entrainement sur le GPU
)
